...
**Marathon (2026).** O caso mais recente e mais documentado. O novo jogo da Bungie é um extraction shooter sci-fi lançado em 5 de março de 2026 após uma trajetória de desenvolvimento turbulenta. Do pico de 1.600 funcionários em meados de 2023, a Bungie chegou ao final de 2024 com cerca de 850, redução de 47% em um ano: em julho de 2024, 220 funcionários foram demitidos (17% do total) e outros 155 transferidos para a Sony Interactive Entertainment.<sup>[3]</sup> O diretor do jogo, Chris Barrett, foi demitido por denúncias de assédio sexual e má conduta e posteriormente entrou com processo contra a Sony. Em 2025, a artista Fern "Antireal" Hook acusou publicamente a Bungie de usar seu pôster de 2017 sem permissão em materiais do jogo, plágio que a Bungie confirmou, e o jogo foi adiado indefinidamente.<sup>[4]</sup>

A comunidade Destiny 2 acrescentou uma camada adicional de hostilidade: ao anunciar que Destiny 2 receberia sua última atualização de conteúdo live-service em 9 de junho de 2026, a Bungie desencadeou uma campanha de review bombing no Steam, com avaliações declarando "Destiny morreu por um extraction shooter mediano" postadas em massa por jogadores que nunca compraram o Marathon. Para essa comunidade, que esperava o anúncio de um Destiny 3, o Marathon era percebido como o motivo pelo qual o jogo que amavam estava sendo encerrado.<sup>[5]</sup>

O resultado comercial foi o seguinte:
...
A Sony registrou um impairment loss de **765 milhões de dólares** sobre a aquisição da Bungie em seu ano fiscal 2025, mais de 21% dos 3,6 bilhões pagos pela compra do estúdio em 2022. A baixa veio em dois momentos: 200 milhões no segundo trimestre, por subadesempenho do Destiny 2, e 565 milhões no quarto trimestre encerrado em 31 de março de 2026, pelo desempenho abaixo das expectativas do Marathon.<sup>[7]</sup>

Em todos esses casos, o sinal estava no texto antes do jogo sair. O volume de buzz negativo, as comparações com fracassos anteriores, as críticas ao modelo de negócios e ao posicionamento do produto estavam acessíveis em posts do Reddit e comentários de trailers no YouTube semanas ou meses antes do lançamento.
...
Este projeto demonstra que texto pré-lançamento do Reddit e comentários de trailers do YouTube é um sinal preditivo do sucesso comercial de videogames, atingindo F1-macro de 0,899 (avaliação) e 0,728 (vendas) com um baseline TF-IDF + Regressão Logística, superando a meta de ≥ 0,70 nos dois targets.

O resultado de que TF-IDF supera DistilBERT fine-tuned no target de avaliação (0,899 vs. 0,880) é o achado empiricamente mais relevante. Ele é consistente com a hipótese de que texto pré-lançamento, sendo curto e denso em palavras-chave, favorece representações esparsas bag-of-words em relação a embeddings contextuais, uma inversão do padrão observado na literatura de reviews pós-lançamento.

A lacuna identificada na revisão de literatura permanece aberta: nenhum trabalho anterior combina restrição temporal pré-lançamento, NLP semântico e domínio de videogames. Extensões naturais incluem modelagem temporal da evolução do sentimento ao longo dos 90 dias, input multimodal com sinais de engajamento em vídeo, e datasets maiores com cobertura mais ampla de Reddit e YouTube.
